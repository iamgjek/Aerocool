...
gulp.task('components',['assets'],function(){
    return gulp.src(['./src/assets/**/*']).pipe(gulp.dest('./App/components'));
});
...
gulp.task('static',['dist'],function(){
    return gulp.src(['./src/static/**/*']).pipe(gulp.dest('./App/static'));
});

gulp.task('dist',['database'],function(){
    return gulp.src(['./src/dist/**/*']).pipe(gulp.dest('./App/dist'));
});

gulp.task('database',['img'],function(){
...
gulp.task('backend',['reSystem'],function(){
    return gulp.src(['./src/backend/**/*','!./src/backend/database/**/*']).pipe(gulp.dest('App/backend'));
});

gulp.task('reSystem',['Nodemodules'],function(){
   let src = ['index.html','package.json','windows.js','systemjs.config.js','elect.js']
